::This is to be elevated and run on a pc
@echo off
...
::
net use M: /delete
net use M: \\ECESVW30401.engr.tamu.edu\Software /user:engr\coe-justin.matthews Test1234
cd Windows\Scripting\justin.matthews
